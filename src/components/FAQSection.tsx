...
const FAQSectionComponent = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "CPIデータは毎年1回、各国政府が前年の年間平均値を発表した後（通常1月下旬〜2月頃）に更新しています。為替レートはリアルタイムで取得しています。"
    },
    {
      question: "計算結果をシェアできますか？",
      answer: "はい、計算結果はX（旧Twitter）やLINEで簡単にシェアできます。メールでの共有も可能です。結果ページのURLも共有可能で、同じ条件での計算を他の人と共有できます。"
    },
    {
      question: "商用利用は可能ですか？",
